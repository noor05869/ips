...
const ReviewApplication = ({
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true)
        const res = PostData.SubmitDocument(values, showSuccessModal);
        res.then(value => {
            const FormSubmit = PostData.SubmitForm(values, showSuccessModal);
    ...
    return (
        ...
        <div className="container-fluid px-0 bg-grey-100">
                                    ...
                                    <div className="accordion-body px-0">
                                        ...
                                        <div className="col-lg-12 col-md-12 col-12">
                                            <div className="row">
                                                ...
                                                <div className="col-lg-3 col-md-12 col-12 mb-3">
                                                    <p className=" fw-600 fs16 tc-grey mb-0">Resident Status in Pakistan</p>
                                                    <p className=" fw-700 fs16 tc-plum Bold">
                                                        {values?.Resident?.children}
                                                    </p>
                                                </div>
                                        ...
                                        <div className="col-lg-12 col-md-12 col-12">
                                            <div className="row">
                                                ...
                                                <div className="col-lg-3 col-md-12 col-12 mb-3">
                                                    ...
                                                    <p className=" fw-700 fs16 tc-plum Bold">
                                                        {values?.PoliticalExpose == 'YES' ? 'Yes' : 'No'}
                                                    </p>
                                                </div>
                                                <div className="col-lg-3 col-md-12 col-12 mb-3">
            ...
            <Modal
                ...
                footer={
                    <Button key="submit" className='w-100' type="primary" onClick={handleSuccessOk}>
                        Continue
                    </Button>
                }
            >
                ...
                <p className="fw-500 fs16 ms-auto">
                    Your account opening form has been submitted. You will be provided with an OTP once the
                    required verification is completed. This may take up to 2 working days.

                    If you're a resident in Pakistan your OTP will be sent to you via SMS from 9646. If you're a non-resident your OTP will be sent to you via email from NCCPL. Please occasionally check your junk mail to not miss the OTP.

                    Once you receive the OTP please come back to submit it.

                    NCCPL is the institution responsible for opening trading accounts
                </p>
