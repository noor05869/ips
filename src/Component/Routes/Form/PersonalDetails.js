              ...
              <form className="mt-40" onSubmit={nextStep}>
                <div className="row mb-5">
                  ...
                  <div className="col-12 col-sm-6 col-lg-4 d-flex flex-column mb-3">
                    ...
                    <div className="mt-auto">
                      <Select defaultValue={values.Resident ? values.Resident : undefined} placeholder="Select any one" onSelect={(value, event) => handleDrctChange("Resident", event)} rules={[{ required: true }]}>
                  ...
                  <div className="col-12 mb-3 col-sm-6 col-lg-4 d-flex flex-column">
                    ...
                    <input
                      type={values.IDType == 'Passport' ? 'text' : 'number'}
                      name="CNIC"
                      className="form-control mt-auto"
                      ...
                      onChange={handleChange}
                      id="CNIC"
                      minLength={values.IDType == 'Passport' ? '55' : '13'}
                      maxLength={values.IDType == 'Passport' ? '55' : '13'}
                      required
                    />
