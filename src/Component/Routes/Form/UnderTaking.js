    ...
    return (
        <div className="container-fluid pb-3">
            <div className="container">
                    ...
                    <div className="undertakingsbody ">
                        <div >
                            ...
                            <p className=" fs16 t-grey-600 fw-600 mb-3">
                                I/ We hereby requset NCCPL to open the account(s) mentioned above on the basis of the information supplied by me/us herein, which I/we confirm is true and correct in all aspect. I/we hereby and confirm that I/we have read, unsderstood and received the copy of Account Opening Form and Terms and Conditions Governing the Account and gereby covenant and agree to observe and be bound by the said Terms and Conditions and any changes, supplements of modifications thereto that may be made by the NCCPL from time to time. </p>

                            <p className=" fs16 t-grey-600 fw-600 mb-3">   I/We authorized NCCPL to deduct their charges, along with excise duty, Goverment Taxes (if applicable). </p>
                            ...
                            <p className=" fs16 t-grey-600 fw-600 mb-3">  If any person classified as United States of America (USA) Person, NCCPL is bound to share acccounts information with the Internal Revenue Service (IRS) of USA and it is clearly Understood that I/we have given our concurrence for this action. </p>
                ...
                {values?.IncomeSource.children == 'Gift' &&
