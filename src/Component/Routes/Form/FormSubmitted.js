                        ...
                        <div className="p-3">
                            <div className="my-3">
                                ...
                                <div className="py-3">
                                    ...
                                    <p className=" statusp fw-600 fs40 my-3 text-center">Your form has been submitted successfully and is currently reviewed by Next Capital. For further information contact us at +92 21 111 639 825</p>
                                </div>
                            </div>
                        </div>
                    </div>
